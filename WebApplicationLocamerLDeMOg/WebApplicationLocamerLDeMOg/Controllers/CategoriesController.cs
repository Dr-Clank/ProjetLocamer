...
namespace WebApplicationLocamerLDeMOg.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "idCate,libelleCate,coefCate")] Categorie categorie)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idCate,libelleCate,coefCate")] Categorie categorie)
        {
            if (ModelState.IsValid)
            {
